...
public class Javagui extends JFrame implements ActionListener {
    ...
    public Javagui()
    {
        ...
        b1=new JButton("Next");
//        i1=new ImageIcon(this.getClass().getResource("/hos.jpg"));
        l2=new JLabel(i1);
        add(l1);
        add(c1);
        add(b1);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==b1)
        {
            if(f==1)
            {
                Javagui.wake("Dr. Harsh Domadia","Dr. Jay Gala","car");
            }
            else
            if(f==2)
            {
                Javagui.wake("Dr. Tushar Kadam","Dr. Sangram Desai","neuro");
            }
            else
            if(f==3)
            {
                Javagui.wake("Dr. Jasdeep Singh","Dr. Atharva Gole","ortho");
            }
        }
    }
